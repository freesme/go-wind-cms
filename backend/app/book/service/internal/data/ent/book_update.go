...
func (_u *BookUpdate) SetStock(v int32) *BookUpdate {
...
func (_u *BookUpdate) SetNillableStock(v *int32) *BookUpdate {
	if v != nil {
		_u.SetStock(*v)
	}
	return _u
...
func (_u *BookUpdate) AddStock(v int32) *BookUpdate {
...
func (_u *BookUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.AddedStock(); ok {
		_spec.AddField(book.FieldStock, field.TypeInt32, value)
	}
...
// SetStock sets the "stock" field.
func (_u *BookUpdateOne) SetStock(v int32) *BookUpdateOne {
	_u.mutation.ResetStock()
	_u.mutation.SetStock(v)
	return _u
}
...
// SetNillableStock sets the "stock" field if the given value is not nil.
func (_u *BookUpdateOne) SetNillableStock(v *int32) *BookUpdateOne {
	if v != nil {
		_u.SetStock(*v)
	}
	return _u
...
// AddStock adds value to the "stock" field.
func (_u *BookUpdateOne) AddStock(v int32) *BookUpdateOne {
	_u.mutation.AddStock(v)
	return _u
}
