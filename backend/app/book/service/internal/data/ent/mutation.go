...
func (m *BookMutation) SetStock(i int32) {
	m.stock = &i
	m.addstock = nil
}

// Stock returns the value of the "stock" field in the mutation.
func (m *BookMutation) Stock() (r int32, exists bool) {
	v := m.stock
	if v == nil {
		return
	}
...
// If the Book object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *BookMutation) OldStock(ctx context.Context) (v int32, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *BookMutation) AddStock(i int32) {
	if m.addstock != nil {
		*m.addstock += i
	} else {
		m.addstock = &i
...
func (m *BookMutation) AddedStock() (r int32, exists bool) {
	v := m.addstock
	if v == nil {
		return
	}
