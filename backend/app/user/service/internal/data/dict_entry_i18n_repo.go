...
import (
	...
	"go-wind-cms/app/user/service/internal/data/ent/dictentry"
	"go-wind-cms/app/user/service/internal/data/ent/dictentryi18n"
	"go-wind-cms/app/user/service/internal/data/ent/predicate"
...
func NewDictEntryI18nRepo(ctx *bootstrap.Context, entClient *entCrud.EntClient[*ent.Client]) *DictEntryI18nRepo {
	repo := &DictEntryI18nRepo{
		log:       ctx.NewLoggerHelper("dict-entry-i18n/repo/user-service"),
		entClient: entClient,
