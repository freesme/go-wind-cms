...
import (
	...
	"go-wind-cms/app/user/service/internal/data/ent/migrate"
	_ "go-wind-cms/app/user/service/internal/data/ent/runtime"
)

// NewEntClient 创建Ent ORM数据库客户端
func NewEntClient(ctx *bootstrap.Context) (*entCrud.EntClient[*ent.Client], func(), error) {
	l := ctx.NewLoggerHelper("ent/data/user-service")
