...
import (
	...
	"go-wind-cms/app/user/service/internal/data/ent/post"
	"go-wind-cms/app/user/service/internal/data/ent/postcategory"
	"go-wind-cms/app/user/service/internal/data/ent/posttag"
...
func NewPostRepo(
	...
	repo := &PostRepo{
		entClient: entClient,
		log:       ctx.NewLoggerHelper("post/repo/user-service"),
